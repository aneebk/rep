public class Golden_Account implements Account
{
	int loan = 100000;
	@Override
	public int withdraw_credit_limit(int balance,int withdraw_amount)
	{
		...
		else if(withdraw_amount > balance && withdraw_amount <= (balance + loan))
		{
			...
			System.out.println("You have withdrawn "+withdraw_amount+"pkr and your loan amount is: "+loan_amount+"pkr\nRemaining Credit for loan is :"+getloan());
			return 0;
		
		}
		else
		{
			System.out.println("You cannot exceed your Golden account limit of 100000pkr");
		}
		return 0;
